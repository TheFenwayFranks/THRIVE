...
import CustomizableProfilePage from './CustomizableProfilePage';
      ...
      <View style={styles.pagesWrapper}>
        ...
        >
          ...
          <View style={[styles.page, { backgroundColor: THRIVE_COLORS.white }]}>
            <CustomizableProfilePage 
              profileData={{
                name: editableProfileData.name || 'Anthony B.',
                bio: editableProfileData.bio || 'Striving for Balance',
                avatar: null
              }}
